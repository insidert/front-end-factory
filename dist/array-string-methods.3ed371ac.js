...
if (a == false) console.log('a is false');
if (a == false) console.log('A is not true');
else console.log('A is true');
if (a == false) console.log('A is not true');
else if (a == 2) console.log('A is not 2');
else console.log('A is true');
...
//# sourceMappingURL=array-string-methods.3ed371ac.js.map
