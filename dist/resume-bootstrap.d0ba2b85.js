  ...
  */ (function(global, factory) {
   ...
   */ class Carousel extends BaseComponent {
        ...
        to(index1) {
            ...
            if (index1 > this._items.length - 1 || index1 < 0) return;
            if (this._isSliding) {
                EventHandler.one(this._element, EVENT_SLID, ()=>this.to(index1)
                );
                return;
            }
            ...
            const order = index1 > activeIndex ? ORDER_NEXT : ORDER_PREV;
            this._slide(order, this._items[index1]);
        }
        _getConfig(config4) {
            config4 = {
                ...Default$a,
        ...
        _getItemByOrder(order1, activeElement) {
            const isNext = order1 === ORDER_NEXT;
   ...
   */ defineJQueryPlugin(Collapse);
    ...
    var placements1 = /*#__PURE__*/ [].concat(basePlacements, [
        auto
    ...
    function within(min$1, value, max$1) {
        return max1(min$1, min1(value, max$1));
    }
    ...
    function getDocumentRect(element) {
        ...
        var width = max1(html.scrollWidth, html.clientWidth, body ? body.scrollWidth : 0, body ? body.clientWidth : 0);
        var height = max1(html.scrollHeight, html.clientHeight, body ? body.scrollHeight : 0, body ? body.clientHeight : 0);
        var x = -winScroll.scrollLeft + getWindowScrollBarX(element);
        var y = -winScroll.scrollTop;
        if (getComputedStyle$1(body || html).direction === 'rtl') x += max1(html.clientWidth, body ? body.clientWidth : 0) - width;
        return {
            width: width,
            height: height,
            x: x,
  ...
  */ function listScrollParents(element, list) {
    ...
    function getClippingRect(element, boundary, rootBoundary) {
        ...
        var clippingRect = clippingParents.reduce(function(accRect, clippingParent) {
            ...
            accRect.top = max1(rect.top, accRect.top);
            accRect.right = min1(rect.right, accRect.right);
            accRect.bottom = min1(rect.bottom, accRect.bottom);
            accRect.left = max1(rect.left, accRect.left);
            return accRect;
    ...
    function computeAutoPlacement(state, options) {
        ...
        var _options = options, placement1 = _options.placement, boundary = _options.boundary, rootBoundary = _options.rootBoundary, padding = _options.padding, flipVariations = _options.flipVariations, _options$allowedAutoP = _options.allowedAutoPlacements, allowedAutoPlacements = _options$allowedAutoP === void 0 ? placements1 : _options$allowedAutoP;
    ...
    function offset1(_ref2) {
        ...
        var data = placements1.reduce(function(acc, placement) {
    ...
    function preventOverflow(_ref) {
        ...
        if (checkMainAxis || checkAltAxis) {
            ...
            if (checkMainAxis) {
                var preventedOffset = within(tether ? min1(min$1, tetherMin) : min$1, offset, tether ? max1(max$1, tetherMax) : max$1);
            ...
            if (checkAltAxis) {
                ...
                var _preventedOffset = within(tether ? min1(_min, tetherMin) : _min, _offset, tether ? max1(_max, tetherMax) : _max);
    ...
    const Popper = /*#__PURE__*/ Object.freeze({
        ...
        clippingParents: clippingParents1,
        viewport,
        popper: popper1,
   ...
   */ class Dropdown extends BaseComponent {
        ...
        _getConfig(config11) {
            ...
            if (typeof config11.reference === 'object' && !isElement$1(config11.reference) && typeof config11.reference.getBoundingClientRect !== 'function') // Popper virtual elements require a getBoundingClientRect method
   ...
   */ const SELECTOR_FIXED_CONTENT = '.fixed-top, .fixed-bottom, .is-fixed, .sticky-top';
    ...
    class ScrollBarHelper {
        ...
        _applyManipulationCallback(selector2, callBack) {
            if (isElement$1(selector2)) callBack(selector2);
   ...
   */ class Tooltip extends BaseComponent {
        ...
        show() {
            ...
            if (this._popper) this._popper.update();
            else this._popper = createPopper(this._element, tip, this._getPopperConfig(attachment));
...
//# sourceMappingURL=resume-bootstrap.d0ba2b85.js.map
